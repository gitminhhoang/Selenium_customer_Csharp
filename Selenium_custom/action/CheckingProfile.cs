...
{
    public partial class CheckingProfile : UserControl
    {
        public CheckingProfile()
        {
            InitializeComponent();
        }

        private void btnCheckingCT_Click(object sender, EventArgs e)
        {
            ...
            if (_uid.Trim().Length > 0)
            {
                ...
                Api api = new Api();
                string data = api.CheckProfileOpen(_uid);
